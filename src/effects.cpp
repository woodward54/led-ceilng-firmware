...
#include "effects/strip/ledSquare.h"
...
void LoadEffectFactories()
{
    ...
    // #define EFFECT_SET_VERSION   0
      ...
      #include "custom_effects.h"
        ...
        // ADD_EFFECT(EFFECT_STRIP_STATUS, StatusEffect, CRGB::White, 1);
        ADD_EFFECT(EFFECT_STRIP_PALETTE, PaletteEffect, GreenColors_p, .25, 1, 0, 1.0, 0.0, LINEARBLEND, true, 1.0);
        // ADD_EFFECT(EFFECT_STRIP_LED_SQUARE, LedSquareEffect, "Unity Control");
